...
Решение:
HW_3_sqlite.ipynb    - выполнено в Colab для SQLite
hw3_for_local_db.py  - выполнено в VS Code для PostgreSQL (локальная БД)
...
Датасет: Набор данных, соответствующих требованиям кредита
